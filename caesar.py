...
class Caesar(Cipher):
    ...
    def __init__(self, offset=3):
        #initialize caesar cipher with offset
        # and forward and backward methods
        # forward adds index of alphabet however many spaces
